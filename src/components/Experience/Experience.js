        ...
        <div className="education">
          ...
          <div className="lambda-education">
            ...
            <p>
              ...
              learning. A lecture in the mornings followed by a project in the
              evenings. Every week there was a sprint challenge that had three
              hour deadlines to teach us how to work under pressure. Every month
              there were build weeks where we were placed with a team, given a
              concept, and expected to work together and communicate to see it
              to completion.
            </p>
          </div>
          ...
          <div className="front-end-masters-education">
            ...
            <p>
              {" "}
              As a self learner, I spent a lot of time scouring the internet for
              resources. One website that I found helpful was Frontend Masters.
            ...
            <ul>
              ...
              <li>
                Javascript, from fundamentals to functional JS v2(8 hours) by
                Bianca Gandolfo
              </li>
              <li>
                {" "}
          ...
          <div className="coding-challenges-education">
            ...
            <p>
              I use Code Wars and Edabit to get at least two hours of practice
              daily.{" "}
            </p>
          </div>
        </div>
